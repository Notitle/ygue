...
<h2><?php  echo __('Product'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($product['Product']['artist_id']); ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Price Size S'); ?></dt>
		<dd>
			<?php echo h($product['Product']['price_size_s']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Price Size M'); ?></dt>
		<dd>
			<?php echo h($product['Product']['price_size_m']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Price Size L'); ?></dt>
		<dd>
			<?php echo h($product['Product']['price_size_l']); ?>
			&nbsp;
		</dd>
